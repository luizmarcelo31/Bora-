...
vi.mock("@/lib/db", () => ({
  prisma: {
    tenantSettings: {
      ...
      upsert: mockTenantSettingsUpsert,
    },
  },
}));
...
describe("SettingsService", () => {
  ...
  describe("getSettings", () => {
    it("retorna settings existentes", async () => {
      ...
      mockTenantSettingsFindUnique.mockResolvedValue(mockSettings);
  ...
  describe("updateSettings", () => {
    it("cria settings via upsert", async () => {
      ...
      mockTenantSettingsUpsert.mockResolvedValue(mockCreated);
    ...
    it("atualiza companyLogoUrl", async () => {
      ...
      mockTenantSettingsUpsert.mockResolvedValue(mockUpdated);
